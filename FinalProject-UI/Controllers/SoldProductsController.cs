...
namespace FinalProject_UI.Controllers
{
    ...
    public class SoldProductsController : ControllerBase
    {
        ...
        public SoldProductsController(coderhouseContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<SoldProduct>> PostSoldProduct(SoldProduct soldProduct)
        {
          if (_context.SoldProducts == null)
          {
              return Problem("Entity set 'coderhouseContext.SoldProducts'  is null.");
          }
